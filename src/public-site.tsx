...
export function PublicSite({ initialPage = "home" }: Props) {
  ...
  return (
    <div className="site">
      ...
      <div id="page-home" className={`page-section${page === "home" ? " active" : ""}`}>
        ...
        <section className="specializes" id="learn-more-section">
          <p className="intro">
            We believe every property has potential. If the house that needs love
            or a vacant piece of land waiting for a future.
          </p>
      ...
      <div id="page-about" className={`page-section${page === "about" ? " active" : ""}`}>
          ...
          <div className="about-inner">
            <div className="vm-grid">
              ...
              <div className="vm-images">
                <img src="/interior1.jpg" alt="Interior" loading="lazy" decoding="async" />
                <img src="/interior2.jpg" alt="Home interior" loading="lazy" decoding="async" />
                <img
                  src="/interior3.jpg"
                  alt="Living space"
                  loading="lazy"
      ...
      <div id="page-join" className={`page-section${page === "join" ? " active" : ""}`}>
            ...
            {submitted ? (
              ...
              <>
                ...
                <p className="lead">
                  ...
                  <br />
                  <br />
                  When you click “Get My Offer,” you're taking the first step
                ...
                <form onSubmit={onSubmit} noValidate={false}>
                  ...
                  <div
                    className={`form-row property-type-row${propertyType === "Other" ? " show-other" : ""}`}
                  >
                    <div className="form-group">
                  ...
                  <div className="checks">
                    ...
                    <div className="check-item">
                      <input type="checkbox" id="sms" name="sms_consent" />
                      <label htmlFor="sms">
      ...
      <div id="page-contact" className={`page-section${page === "contact" ? " active" : ""}`}>
        <section className="about" style={{ paddingBottom: "2rem" }}>
          <div className="about-inner" style={{ textAlign: "center", maxWidth: 600 }}>
            <h2
              style={{
            ...
            >
              <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <circle
                  ...
                  strokeWidth="1.85"
                />
                <circle cx="17.15" cy="6.9" r="1.15" fill="#fff" />
              </svg>
              <span>Instagram</span>
            </a>
          </div>
